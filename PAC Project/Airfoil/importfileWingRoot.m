function [NACA,VarName2] = importfileWingRoot(~, startRow, endRow)
...
%    See also TEXTSCAN.
% ii1 = [];
global NACA VarName2 wingAirfoilFileRoot fileID masterFile
% file = 'm1.dat';
...
wingAirfoilFileDir = dir(wingAirfoilFileRoot);

% Input specified airfoil into MATLAB
wingAirfoilFileRoot = wingAirfoilFileDir.name;

%% Open the text file.
fileID = fopen(wingAirfoilFileRoot,'r');
