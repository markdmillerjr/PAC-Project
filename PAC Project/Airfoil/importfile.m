function a18 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   A18 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   A18 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   a18 = importfile('a18.dat', 2, 42);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/04/27 21:08:58
...
a18 = table(dataArray{1:end-1}, 'VariableNames', {'A18','original'});
